...
<cms:template title='Video Page Coming soon'> 
    <cms:editable name='video_coming_soon' label="Video Coming Soon" type='richtext'/>
</cms:template>  
...
<meta name="description" content="Seven-Delta | Seven Delta Consulting" />
        ...
        <div class="display-table-cell">
          ...
          <div class="text-center mb-60"><a href="<cms:link 'homepage.php' />" class=""><img alt="" src="images/logo-delta.png"></a></div>
              ...
              <div class="col-md-10 col-md-offset-1">
                <h1 class="font-weight-100 font-64">Videos Coming Soon</h1>
              ...
              <div class="col-md-8 col-md-offset-2">
                ...
                <p class="font-14"> We  will post our videos soon.<br>Subscribe to the newsletter to get notified</p>
              </div>
            </div>
          </div>
        </div>
