...
<cms:template title='Asia Coming Soon'> 
    <cms:editable name='asia_coming_soon' label="Asia coming soon" type='richtext'/>
</cms:template>  
        ...
        <div class="display-table-cell">
          ...
          <div class="text-center mb-60"><a href="<cms:link 'homepage.php' />" class=""><img alt="" src="images/logo-delta.png"></a></div>
              ...
              <div class="col-md-8 col-md-offset-2">
                ...
                <p class="font-14"> We will showcase our projects in Asia  soon.<br>Subscribe to the newsletter to get notified</p>
              </div>
            </div>
          </div>
        </div>
