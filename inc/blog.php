    ...
    <section id="home" class="bg-lightest fullscreen">
      <div class="display-table text-center">
        <div class="display-table-cell">
          ...
          <div class="text-center mb-60"><a href="homepage.php" class=""><img alt="" src="images/logo-delta.png"></a></div>

              <div class="col-md-10 col-md-offset-1">
                <h1 class="font-weight-100 font-64">Blog Posts Coming Soon</h1>
              ...
              <div class="col-md-8 col-md-offset-2">
                ...
                <p class="font-14"> We will showcase our blog posts soon.<br>Subscribe to the newsletter to get notified</p>
              </div>
            </div>
          </div>
        </div>
